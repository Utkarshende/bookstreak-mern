...
const HomePage = () => {
    ...
    return (
        <div className="flex flex-col space-y-10">
            <header className="bg-white p-8 rounded-2xl shadow-2xl text-center border-b-4 border-teal-600">
                <h1 className="text-5xl font-extrabold text-teal-800 m-0 tracking-tight animate-fadeIn">
