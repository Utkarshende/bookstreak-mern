    ...
    return (
        <div className="flex flex-col h-[70vh] bg-white rounded-xl shadow-2xl">
            <header className="p-4 bg-indigo-600 text-white rounded-t-xl">
                <h1 className="text-xl font-bold">BookStreak Chat: {currentRoom.replace('_', ' ').toUpperCase()}</h1>
                <p className={`text-sm ${isConnected ? 'text-green-300' : 'text-red-300'}`}>
            ...
            <footer className="p-4 border-t border-gray-200">
                <form onSubmit={handleSubmit} className="flex space-x-3">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 disabled:bg-gray-400"
                    >
                        Send
                    </button>
                </form>
